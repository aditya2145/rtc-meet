...
const joinMeeting = asyncHandler(async (req, res) => {
        ...
        if(room.host.toString() === userId.toString()) {
            return res.status(200).json(new ApiResponse(200, room));
        }
        ...
        if (alreadyJoined) {
            ...
            return res.status(409).json(new ApiError(409, "You are already in the meeting"));
        }
        ...
        res.status(200).json(new ApiResponse(200, room, "Meeting joined successfully"));
});
...
const leaveMeeting = asyncHandler(async (req, res) => {
        ...
        res.status(200).json(new ApiResponse(200, null, "Left meeting successfully"));
});
...
const endMeeting = asyncHandler(async (req, res) => {
        ...
        if (room.host.toString() !== userId.toString()) {
            return res.status(400).json(new ApiError(400, "You don't have access to end the meeting"));
        }
        room.endTime = new Date();
        await room.save();
        res.status(200).json(new ApiResponse(200, null, "Meeting ended successfully"));
});
...
const upcomingMeetings = asyncHandler(async (req, res) => {
        ...
        res.status(200).json(new ApiResponse(200, meetings, "Upcoming meetings fetched successfully"));
});
...
const pastMeetings = asyncHandler(async (req, res) => {
        ...
        res.status(200).json(new ApiResponse(200, meetings, "Past meetings fetched successfully"));
});
...
const ongoingMeetings = asyncHandler(async(req, res) => {
        ...
        res.status(200).json(new ApiResponse(200, meetings, "Ongoing meetings fetched successfully"));
});
...
const getMeetingDetails = asyncHandler(async(req, res) => {
        ...
        res.status(200).json(new ApiResponse(200, room, "Meeting details fetched successfully"));
});
